...
void M6532::install(System& system, Device& device)
{
  // Remember which system I'm installed in
    ...
    for (int address = 0; address < 8192; address += (1 << System::S_PAGE_SHIFT))
...
void M6532::setPinState(bool swcha)
{
  ...
  */
    ...
    port0.write(Controller::One, (ioport & 0x10) != 0);
    port0.write(Controller::Two, (ioport & 0x20) != 0);
    port0.write(Controller::Three, (ioport & 0x40) != 0);
    port0.write(Controller::Four, (ioport & 0x80) != 0);
    port1.write(Controller::One, (ioport & 0x01) != 0);
    port1.write(Controller::Two, (ioport & 0x02) != 0);
    port1.write(Controller::Three, (ioport & 0x04) != 0);
    port1.write(Controller::Four, (ioport & 0x08) != 0);

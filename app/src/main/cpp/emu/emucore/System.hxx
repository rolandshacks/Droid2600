...
class System : public Serializable
{
    ...
    static constexpr uInt16 S_ADDRESS_MASK = (1 << 13) - 1;

    // Amount to shift an address by to determine what page it's on
    static constexpr uInt16 S_PAGE_SHIFT = 6;

    // Mask to apply to an address to obtain its page offset
    static constexpr uInt16 S_PAGE_MASK = (1 << S_PAGE_SHIFT) - 1;

    // Number of pages in the system
    static constexpr uInt16 S_NUM_PAGES = 1 << (13 - S_PAGE_SHIFT);
    ...
    */
    System::PageAccessType getPageAccessType(uInt16 addr) const {
        return myPageAccessTable[(addr & S_ADDRESS_MASK) >> S_PAGE_SHIFT].type;
    }
    ...
    */
    void setDirtyPage(uInt16 addr) {
        myPageIsDirtyTable[(addr & S_ADDRESS_MASK) >> S_PAGE_SHIFT] = true;
    }
    ...
    */
    ...
    PageAccess myPageAccessTable[S_NUM_PAGES];

    // The list of dirty pages
    bool myPageIsDirtyTable[S_NUM_PAGES];

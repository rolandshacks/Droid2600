...
void CartridgeFA2::install(System& system)
{
    ...
    for (uInt32 j = 0x1000; j < 0x1100; j += (1 << System::S_PAGE_SHIFT))
    {
    ...
    for (uInt32 k = 0x1100; k < 0x1200; k += (1 << System::S_PAGE_SHIFT))
    {
...
bool CartridgeFA2::bank(uInt16 bank)
{
    ...
    for (uInt32 i = (0x1FF4 & ~System::S_PAGE_MASK); i < 0x2000;
    ...
    for (uInt32 address = 0x1200; address < (0x1FF4U & ~System::S_PAGE_MASK);

...
void CartridgeUA::install(System& system)
{
    ...
    myHotSpotPageAccess = mySystem->getPageAccess(0x0220 >> System::S_PAGE_SHIFT);

    // Set the page accessing methods for the hot spots
    System::PageAccess access(this, System::PA_READ);
    mySystem->setPageAccess(0x0220 >> System::S_PAGE_SHIFT, access);
    mySystem->setPageAccess(0x0240 >> System::S_PAGE_SHIFT, access);

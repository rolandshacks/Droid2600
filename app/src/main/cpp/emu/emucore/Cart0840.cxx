...
void Cartridge0840::install(System& system)
{
    ...
    myHotSpotPageAccess[0] = mySystem->getPageAccess(0x0800 >> System::S_PAGE_SHIFT);
    myHotSpotPageAccess[1] = mySystem->getPageAccess(0x0900 >> System::S_PAGE_SHIFT);
    myHotSpotPageAccess[2] = mySystem->getPageAccess(0x0A00 >> System::S_PAGE_SHIFT);
    myHotSpotPageAccess[3] = mySystem->getPageAccess(0x0B00 >> System::S_PAGE_SHIFT);
    myHotSpotPageAccess[4] = mySystem->getPageAccess(0x0C00 >> System::S_PAGE_SHIFT);
    myHotSpotPageAccess[5] = mySystem->getPageAccess(0x0D00 >> System::S_PAGE_SHIFT);
    myHotSpotPageAccess[6] = mySystem->getPageAccess(0x0E00 >> System::S_PAGE_SHIFT);
    myHotSpotPageAccess[7] = mySystem->getPageAccess(0x0F00 >> System::S_PAGE_SHIFT);

    // Set the page accessing methods for the hot spots
    System::PageAccess access(this, System::PA_READ);
    for (uInt32 i = 0x0800; i < 0x0FFF; i += (1 << System::S_PAGE_SHIFT))
...
bool Cartridge0840::bank(uInt16 bank)
{
    ...
    for (uInt32 address = 0x1000; address < 0x2000; address += (1 << System::S_PAGE_SHIFT))
    {

...
class EventHandler
{
    ...
    */
    ...
    {
#ifndef BSPF_MAC_OSX
        return ((mod & KBDM_ALT) != 0x0);
#else
        return ((mod & KBDM_GUI) != 0x0);
#endif
    }

    inline bool kbdControl(int mod) const
    {
        return ((mod & KBDM_CTRL) != 0x0);
    }

    inline bool kbdShift(int mod) const
    {
        return ((mod & KBDM_SHIFT) != 0x0);
    }
...
*/
    ...
    */
    void enableTextEvents(bool enable) { ; }  //// DISABLED

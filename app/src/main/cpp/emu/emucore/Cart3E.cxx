...
void Cartridge3E::install(System& system)
{
    ...
    for (uInt32 j = 0x1800; j < 0x2000; j += (1 << System::S_PAGE_SHIFT))
    {
...
bool Cartridge3E::bank(uInt16 bank)
{
    ...
    else
    {
        ...
        for (address = 0x1000; address < 0x1400; address += (1 << System::S_PAGE_SHIFT))
        {
        ...
        for (address = 0x1400; address < 0x1800; address += (1 << System::S_PAGE_SHIFT))
        {

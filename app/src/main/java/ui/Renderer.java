...
public class Renderer implements GLSurfaceView.Renderer {
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        long elapsedMillis = (lastDrawTime != 0) ? (currentTime - lastDrawTime) : 0;
        lastDrawTime = currentTime;

        float elapsed = ((float) elapsedMillis / 1000.0f);
    ...
    protected void enableAlphaBlending() {
        gl.glEnable(GL10.GL_BLEND);
    }
    ...
    protected Texture loadTexture(String name) {
        ...
        return new Texture(texture, bitmap.getWidth(), bitmap.getHeight());
    }

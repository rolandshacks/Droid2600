...
public class VirtualGamepad {
    ...
    public static final int STICK_FIRE = 0x01;
    public static final int STICK_LEFT = 0x02;
    public static final int STICK_RIGHT = 0x04;
    public static final int STICK_UP = 0x08;
    public static final int STICK_DOWN = 0x10;
    ...
    private int updateStick(View v, int action, float x, float y, int stick) {
        ...
        if (isLeft) {
            ...
            stick &= (~STICK_FIRE);
            stick |= (rightPressed ? STICK_FIRE : 0);
